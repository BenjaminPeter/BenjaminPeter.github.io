...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<faraday-gzip>.freeze, [">= 0.1", "< 2.0"])
    s.add_dependency(%q<faraday-http-cache>.freeze, ["~> 2.5"])
    s.add_dependency(%q<faraday-retry>.freeze, ["~> 2.0"])
    s.add_dependency(%q<addressable>.freeze, ["~> 2.8.4"])
    ...
    s.add_dependency(%q<puma>.freeze, ["~> 6.2.2"])
    s.add_dependency(%q<rubocop>.freeze, ["~> 1.34"])
    s.add_dependency(%q<resolv>.freeze, ["~> 0.2.2"])
